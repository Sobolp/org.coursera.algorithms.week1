...
public class PointSETTest {
    ...
    private Iterable<Point2D> loadPoints(String fileName) throws FileNotFoundException {
    ...
    public void setUp() throws Exception {
        empty = new PointSET();
        circle4 = new PointSET();
        for (Point2D p : loadPoints("./txt/week5/circle4.txt"))
            circle4.insert(p);
        circle10 = new PointSET();
        for (Point2D p : loadPoints("./txt/week5/circle10.txt"))
            circle10.insert(p);
    }
    ...
    public void testNearest() throws Exception {
        ...
        assertEquals("circle10.txt nearest point to Point(0.0,0.0) is Point(0.206107 0.095492)",
                "(0.2061070054769516, 0.09549199789762497)",circle10.nearest(new Point2D(0.0,0.0)).toString());
